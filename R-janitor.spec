...
Version  : 2.2.1
Release  : 50
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/janitor_2.2.1.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/janitor_2.2.1.tar.gz
...
%setup -q -n janitor
pushd ..
cp -a janitor buildavx2
popd
pushd ..
cp -a janitor buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735108089
